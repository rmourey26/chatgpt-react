...
If you are looking for a simple HTML/vanilla JavaScript version, check [here](https://github.com/rmourey26/chatgpt-playground)
...
```sh
git clone https://github.com/rmourey26/chatgpt-react
```
